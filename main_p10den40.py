...
scipy.io.savemat('./p10den40/p10test_acc_all.mat', mdict={'p10test_acc_all': test_acc_all})
scipy.io.savemat('./p10den40/p10val_acc_all.mat', mdict={'p10val_acc_all': val_acc_all})        
