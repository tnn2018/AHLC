...
scipy.io.savemat('./p2/test_acc_all.mat', mdict={'test_acc_all': test_acc_all})
scipy.io.savemat('./p2/val_acc_all.mat', mdict={'val_acc_all': val_acc_all})        